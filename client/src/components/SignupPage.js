...
const SignupPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      // ⚠️ Using your local IP directly
      await axios.post(`${process.env.REACT_APP_API_URL}/api/signup`, { username, password });
      ...
      <div style={styles.contentWrap}>
        <div style={styles.card}>
          <div style={{ marginBottom: '30px' }}>
            ...
            <p style={styles.subtitle}>Join Jingulala Furniture today</p>
          </div>
          ...
          <form onSubmit={handleSignup} style={styles.form}>
            <div style={styles.inputGroup}>
              ...
              <input 
                  type="text" 
                  placeholder="e.g. FurnitureFan123" 
